  ...
  return (
    <main className="min-h-[calc(100vh-4rem)] min-w-0 overflow-x-hidden bg-background text-foreground">
      <section className="border-b border-border">
        <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-10 md:flex-row md:items-start md:justify-between md:gap-10 md:py-12">
          <div className="max-w-[34rem]">
            <h1
              className="text-4xl font-semibold leading-[1.05] tracking-tight text-foreground sm:text-5xl md:text-6xl"
            >
              노래를 고르고,
              <br />
              부르면서 AI로
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-2">
              <Link
                href="/analyze"
                className="group rounded-2xl border border-border bg-muted p-5 shadow-sm transition-colors hover:bg-accent"
              >
              ...
              <Link
                href="/instrument"
                className="group rounded-2xl border border-border bg-background p-5 shadow-sm transition-colors hover:bg-muted"
              >
                <div className="flex items-center gap-2 text-sm font-medium text-muted-foreground">
      ...
      <section className="mx-auto max-w-6xl px-4 py-14">
        <div className="rounded-[2rem] bg-foreground px-6 py-10 text-background sm:px-10">
          <p className="text-sm font-medium text-background/50">다음 단계</p>
          <div className="mt-3 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            ...
            <Link
              href="/analyze"
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-background px-5 py-3 text-sm font-medium text-foreground transition-colors hover:bg-muted"
            >
              기능 시나리오 확인
